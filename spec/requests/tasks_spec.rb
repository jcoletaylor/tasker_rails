  ...
  describe 'POST /create' do
    context 'with valid parameters' do
      ...
      it 'renders a JSON response with the new task' do
        post tasks_url, params: { task: valid_attributes }, headers: valid_headers, as: :json
  ...
  describe 'PATCH /update' do
    ...
    context 'with invalid parameters' do
      it 'renders a JSON response with errors for the task' do
        task = Task.create! valid_attributes
        patch task_url(task), params: { task: invalid_attributes }, headers: valid_headers, as: :json
        expect(response).to have_http_status(:unprocessable_entity)
        expect(response.content_type).to eq('application/json')
      end
    end
